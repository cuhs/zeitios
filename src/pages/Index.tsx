    ...
    <>
      ...
      <div className="min-h-screen bg-[#EDF4FF] flex items-center justify-center pt-16">
        <div className="container max-w-4xl mx-auto py-8 space-y-8">
          ...
          {selectedTopic && (
            <div ref={chatRef} className="space-y-8 animate-slide-up scroll-mt-24">
              <div className="p-4 bg-white/50 backdrop-blur-sm border border-[#2866C5]/20 rounded-2xl mb-8 flex justify-between items-center">
                <h3 className="text-lg font-bold text-gray-900">{selectedTopic}</h3>
                <button 
                  onClick={() => setSelectedTopic(null)}
                  className="text-sm text-[#2866C5] hover:text-[#2866C5]/80 transition-colors underline"
                >
                  Change Topic
                </button>
              </div>
